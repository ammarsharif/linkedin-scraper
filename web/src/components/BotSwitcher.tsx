...
export const BOTS = [
  ...
  },
  {
    ...
    icon: Zap,
    color: "#c96ef5",
    bg: "rgba(201,110,245,0.1)",
    requiredLocal: "sienna_payload",
  },
  {
    id: "cara",
    name: "Cara",
    desc: "Avatar Simulator",
    path: "/cara",
    icon: UserCheck,
    color: "#f43f5e",
  ...
  },
  {
    id: "febo",
    name: "Febo",
    desc: "Sales Scripts & FB Engagement",
    path: "/febo",
    icon: Target,
    color: "#6366f1",
    bg: "rgba(99,102,241,0.1)",
            ...
            {filteredBots.map((bot) => (
              <button
                ...
                onClick={() => {
                  if (
                    bot.requiredLocal &&
                    !localStorage.getItem(bot.requiredLocal)
                  ) {
                    setShowAlert({
              ...
              >
                <div
                  ...
                  style={{
                    background: `linear-gradient(135deg, ${bot.color}, #1e293b)`,
                  }}
                >
                ...
                {currentBotId === bot.id && (
                  <div
                    className="ml-auto w-2 h-2 rounded-full shadow-[0_0_8px_currentColor]"
                    style={{ background: bot.color, color: bot.color }}
                  />
                )}
              </button>
            ))}
