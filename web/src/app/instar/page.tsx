        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              style={{
                background: (activeTab === "growth" ? growRunning : dmRunning) ? "rgba(239,68,68,0.1)" : "rgba(225,48,108,0.1)",
                borderColor: (activeTab === "growth" ? growRunning : dmRunning) ? "rgba(239,68,68,0.2)" : "rgba(225,48,108,0.2)",
        ...
        >
          {TABS.map((tab) => (
            <button
              ...
              style={{
                background: activeTab === tab.id ? "rgba(225,48,108,0.1)" : "transparent",
                color: activeTab === tab.id ? INSTAR_COLOR : "rgba(255,255,255,0.5)",
                border: activeTab === tab.id ? "1px solid rgba(225,48,108,0.2)" : "1px solid transparent",
              }}
            >
              <tab.icon 
                size={16} 
                className={`transition-colors ${activeTab === tab.id ? "text-[#e1306c]" : "text-gray-500 group-hover:text-gray-300"}`} 
              />
              {tab.label}
              {tab.id === "dm-reply" && convLogs.length > 0 && (
                <span className="ml-1 px-1.5 py-0.5 rounded-md text-[10px] font-bold transition-colors" style={{ 
                  background: activeTab === tab.id ? "rgba(225,48,108,0.2)" : "rgba(255,255,255,0.08)",
                  color: activeTab === tab.id ? INSTAR_COLOR : "rgba(255,255,255,0.6)"
                }}>
                  {convLogs.length}
                </span>
              )}
          ...
          <div className="animate-fade-in max-w-3xl mx-auto space-y-6">
            ...
            <div
              ...
              style={{
                ...
                borderColor: dmRunning ? "rgba(225,48,108,0.2)" : "rgba(255,255,255,0.06)",
              }}
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div
                    ...
                    style={{ 
                      background: dmRunning ? "rgba(225,48,108,0.12)" : "rgba(239,68,68,0.08)",
                      border: `1px solid ${dmRunning ? "rgba(225,48,108,0.25)" : "rgba(239,68,68,0.15)"}`
                    }}
                  >
                    {dmRunning ? (
                      <Zap size={22} style={{ color: INSTAR_COLOR }} />
                    ) : (
                ...
                <button
                  ...
                  style={{
                    background: dmRunning ? "rgba(239,68,68,0.08)" : "rgba(225,48,108,0.1)",
                    borderColor: dmRunning ? "rgba(239,68,68,0.2)" : "rgba(225,48,108,0.3)",
                    color: dmRunning ? "#ef4444" : INSTAR_COLOR,
                  }}
                >
                  {dmRunning ? (
                    <><Square size={16} /> Stop</>
