        ...
        <div className="flex items-center gap-3">
          ...
          {hook.sourcePostUrl && (
            <a
              ...
              style={{ color: "#00a0dc" }}
            >
              Source post <ExternalLink size={10} className="inline ml-1" />
            </a>
          )}
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {post.postUrl && (
          <a
            ...
            style={{ color: "#00a0dc" }}
          >
            View post <ExternalLink size={10} className="inline ml-1" />
          </a>
        )}
      </div>
    </div>
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5">
          ...
          <div className="flex items-center gap-4">
            ...
            <BotSwitcher currentBotId="sienna" />
          </div>
            ...
            >
              ...
              >
                {loading ? (
                  ...
                  <>
                    <Zap size={16} stroke="currentColor" strokeWidth={2.5} />
            ...
            {!result && !loading && (
              <div className="flex h-[520px] items-center justify-center animate-fade-in-delay-1">
                <div className="text-center">
                  ...
                  >
                    <Zap size={24} stroke="#c96ef5" strokeWidth={1.5} />
                  </div>
                  <h2
            ...
            {loading && (
              <div className="flex h-64 items-center justify-center">
                <div className="text-center">
                  ...
                  >
                    <Zap size={24} stroke="white" strokeWidth={2} />
                  </div>
                  <p
